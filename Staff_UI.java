...
import javax.swing.*;
public class Staff_UI  extends User_Interface
{
    ...
    public void setstudent(User user){this.user=new Staff(user.getAccount(), user.getPassword(), user.getName(),user.getIdentity(),Integer.toString(user.getFines()));}
}